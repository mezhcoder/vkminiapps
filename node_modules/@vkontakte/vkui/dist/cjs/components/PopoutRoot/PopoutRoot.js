...
var PopoutRootComponent = function PopoutRootComponent(props) {
  var popout = props.popout,
      ...
      restProps = (0, _objectWithoutProperties2.default)(props, ["popout", "modal", "viewWidth", "children", "getRootRef"]);

  var _useDOM = (0, _dom.useDOM)(),
      document = _useDOM.document;

  var isDesktop = viewWidth >= _withAdaptivity.ViewWidth.TABLET;
