...
var ContentCard = function ContentCard(props) {
  var getRef = props.getRef,
      ...
      restProps = (0, _objectWithoutProperties2.default)(props, ["getRef", "onClick", "subtitle", "header", "text", "caption", "className", "image", "maxHeight", "disabled", "mode", "alt", "style", "getRootRef"]);
  ...
  }, image && (0, _jsxRuntime.createScopedElement)("img", (0, _extends2.default)({}, restProps, {
    ref: getRef,
    src: image,
    alt: alt,
