...
var Select = function Select(_ref) {
  var hasMouse = _ref.hasMouse,
      props = (0, _objectWithoutProperties2.default)(_ref, ["hasMouse"]);

  // Use custom select if device has connected a mouse
  if (hasMouse) {
    var children = props.children,
        _restProps = (0, _objectWithoutProperties2.default)(props, ["children"]);
  ...
  var _props$options = props.options,
      ...
      restProps = (0, _objectWithoutProperties2.default)(props, ["options", "popupDirection", "renderOption"]);
