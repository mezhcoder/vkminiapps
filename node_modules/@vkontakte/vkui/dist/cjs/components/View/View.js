...
var View = /*#__PURE__*/function (_Component) {
  ...
  function View(props) {
    ...
    _this.state = {
      scrolls: scrollsCache[(0, _getNavId.getNavId)(props, false)] || {},
      animated: false,
  ...
  (0, _createClass2.default)(View, [{
    ...
    value: function componentWillUnmount() {
      var id = (0, _getNavId.getNavId)(this.props, false);
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (prevProps.activePanel !== this.props.activePanel && !prevState.swipingBack && !prevState.browserSwipe) {
        var firstLayerId = this.panels.map(function (panel) {
          return (0, _getNavId.getNavId)(panel.props);
        }).find(function (id) {
    ...
    value: function render() {
      ...
      var panels = this.panels.filter(function (panel) {
        var panelId = (0, _getNavId.getNavId)(panel.props);
