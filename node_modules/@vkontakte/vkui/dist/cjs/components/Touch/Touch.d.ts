...
import { DragEvent, ElementType, MouseEvent as ReactMouseEvent, AllHTMLAttributes } from 'react';
...
export declare type ClickHandler = (e: ReactMouseEvent<HTMLElement>) => void;
export declare type DragHandler = (e: DragEvent<HTMLElement>) => void;
declare const _default: import("react").ComponentType<TouchProps>;
