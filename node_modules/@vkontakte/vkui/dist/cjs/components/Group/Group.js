...
var Group = function Group(props) {
  var header = props.header,
      ...
      mode = props.mode,
      sizeX = props.sizeX,
      restProps = (0, _objectWithoutProperties2.default)(props, ["header", "description", "children", "separator", "getRootRef", "mode", "sizeX"]);

  var _useContext = (0, _react.useContext)(_ModalRootContext.default),
      isInsideModal = _useContext.isInsideModal;

  var platform = (0, _usePlatform.usePlatform)();
  var baseClassNames = (0, _getClassName.getClassName)('Group', platform);
  ...
  return (0, _jsxRuntime.createScopedElement)("section", (0, _extends2.default)({}, restProps, {
    ref: getRootRef,
    vkuiClass: (0, _classNames.classNames)(baseClassNames, "Group--sizeX-".concat(sizeX), "Group--".concat(computedMode))
  }), (0, _jsxRuntime.createScopedElement)("div", {
    vkuiClass: "Group__inner"
  }, header, children, (0, _utils.hasReactNode)(description) && (0, _jsxRuntime.createScopedElement)("div", {
