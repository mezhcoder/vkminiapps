...
var SimpleCellTypography = (0, _withAdaptivity.withAdaptivity)(function (props) {
  var sizeY = props.sizeY,
      children = props.children,
      restProps = (0, _objectWithoutProperties2.default)(props, ["sizeY", "children"]);
...
var SimpleCell = function SimpleCell(_ref) {
  var badge = _ref.badge,
      ...
      sizeY = _ref.sizeY,
      restProps = (0, _objectWithoutProperties2.default)(_ref, ["badge", "before", "indicator", "children", "after", "description", "expandable", "multiline", "Component", "onClick", "sizeY"]);
  var platform = (0, _usePlatform.usePlatform)();

  var hasAfter = (0, _utils.hasReactNode)(after) || expandable && platform === _platform.IOS;

  var RootComponent = restProps.disabled ? Component : _Tappable.default;
  var props = restProps;
  ...
  return (0, _jsxRuntime.createScopedElement)(RootComponent, (0, _extends2.default)({}, props, {
  ...
  }, badge)), description && (0, _jsxRuntime.createScopedElement)(_Caption.default, {
    weight: "regular",
    level: "1",
