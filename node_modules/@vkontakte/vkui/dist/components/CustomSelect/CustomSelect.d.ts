import React, { ChangeEventHandler, MouseEvent, ReactNode, SelectHTMLAttributes } from 'react';
import { NativeSelectProps } from '../NativeSelect/NativeSelect';
import { CustomSelectOptionProps } from '../CustomSelectOption/CustomSelectOption';
import { FormFieldProps } from '../FormField/FormField';
import { HasPlatform } from '../../types';
declare type SelectValue = SelectHTMLAttributes<HTMLSelectElement>['value'];
...
declare type MouseEventHandler = (event: MouseEvent<HTMLElement>) => void;
declare class CustomSelect extends React.Component<CustomSelectProps, CustomSelectState> {
    ...
    rootRef: (element: HTMLLabelElement) => void;
