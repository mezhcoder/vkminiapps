...
var Touch = /*#__PURE__*/function (_Component) {
  ...
  function Touch() {
    ...
    _defineProperty(_assertThisInitialized(_this), "preventClickDefault", false);

    _defineProperty(_assertThisInitialized(_this), "stopClickPropagation", false);

    _defineProperty(_assertThisInitialized(_this), "gesture", {});

    _defineProperty(_assertThisInitialized(_this), "container", void 0);

    _defineProperty(_assertThisInitialized(_this), "subscribed", false);
    ...
    _defineProperty(_assertThisInitialized(_this), "onEnd", function (e) {
      ...
      if (isPressed) {
        ...
        _this.stopClickPropagation = _this.props.noSlideClick && isSlide;
      }

      var target = e.target; // Если закончили жест на ссылке, выставляем флаг для отмены перехода

      _this.preventClickDefault = target.tagName === 'A' && isSlide;
    ...
    _defineProperty(_assertThisInitialized(_this), "onClick", function (e) {
      if (_this.preventClickDefault) {
        _this.preventClickDefault = false;
        e.preventDefault();
      }

      if (_this.stopClickPropagation) {
        _this.stopClickPropagation = false;
        e.stopPropagation();
        return;
      }
  ...
  _createClass(Touch, [{
    ...
    value: function componentWillUnmount() {
      this.container.removeEventListener(events[0], this.onStart); // unsubscribe if touchEnabled OR !touchEnabled & gesture in progress
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          restProps = _objectWithoutProperties(_this$props, ["onStart", "onStartX", "onStartY", "onMove", "onMoveX", "onMoveY", "onLeave", "onEnter", "onEnd", "onEndX", "onEndY", "useCapture", "Component", "getRootRef", "noSlideClick", "window", "document"]);
